...
CREATE TABLE `posts_surveys` (
  `survey_is` int(10) UNSIGNED NOT NULL,
  `post_id` int(10) UNSIGNED NOT NULL,
  `survey_url` varchar(256) NOT NULL,
  `title` varchar(256) NOT NULL,
  `text` longtext NOT NULL,
  `survey_category` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(6, 'system_keywords', ''),
(7, 'system_email', 'zamblek@outlook.com'),
...
(147, 'ftp_path', ''),
(148, 'ftp_endpoint', ''),
(149, 'session_hash', '7kBUMcXZy-4gWOm-45BaB-3Mplo-2GKB5-80e43af61055'),
...
--
ALTER TABLE `system_currencies`
  MODIFY `currency_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `system_options`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1355;
