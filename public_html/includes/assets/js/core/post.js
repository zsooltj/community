...
function publisher_tab(publisher, tab) {
  /* toggle active class */
  publisher
    .find('.js_publisher-tab[data-tab="' + tab + '"]')
    .toggleClass("active");
  ...
  switch (tab) {
    case "scraper":
      /* toggle conflicted tabs */
      publisher
        .find('.js_publisher-tab[data-tab="offer"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="job"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="live"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="photos"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="album"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="colored"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="voice_notes"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="gif"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="product"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="article"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="poll"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="video"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="audio"]')
        .toggleClass("disabled");
      publisher
        .find('.js_publisher-tab[data-tab="file"]')
        .toggleClass("disabled");
      break;
    ...
    case "album":
      /* toggle meta */
      publisher
        .find('.publisher-meta[data-meta="album"]')
        .slideToggle("fast")
        .find("input")
        .focus();
      /* toggle conflicted tabs */
    ...
    case "location":
      /* toggle meta */
      publisher
        .find('.publisher-meta[data-meta="location"]')
        .slideToggle("fast")
        .find("input")
        .focus();
      break;
    ...
    case "colored":
      /* toggle meta */
      publisher
        .find('.publisher-meta[data-meta="colored"]')
        .slideToggle("fast")
        .find("input")
        .focus();
      /* toggle conflicted tabs */
    ...
    case "voice_notes":
      /* toggle meta */
      publisher
        .find('.publisher-meta[data-meta="voice_notes"]')
        .slideToggle("fast");
      /* toggle conflicted tabs */
      publisher
        .find('.js_publisher-tab[data-tab="offer"]')
    ...
    case "gif":
      /* toggle meta */
      publisher
        .find('.publisher-meta[data-meta="gif"]')
        .slideToggle("fast")
        .find("input")
        .focus();
      /* toggle conflicted tabs */
    ...
    case "poll":
      ...
      if (
        publisher.find('.js_publisher-tab[data-tab="poll"]').hasClass("active")
      ) {
        publisher
          .find("textarea")
        ...
        publisher
          ...
          .attr(
            "placeholder",
            publisher.find("textarea").data("init-placeholder")
          )
          .focus();
      }
      /* toggle conflicted tabs */
...
$(function () {
  ...
  if (
    ...
    if (hours >= 0 && hours < 12) {
      ...
      $(render_template("#message-afternoon"))
  ...
  $("body").on("click", function (e) {
    ...
    if ($(".publisher:not(.mini)").length > 0) {
      if (
        ...
        $(e.target).parents(".js_publisher-attachment-image-remover").length >
          0 ||
        ...
        if ($('.js_publisher-tab[data-tab="colored"]').hasClass("activated")) {
          ...
          if (!publisher_message.hasClass("colored")) {
            ...
            if (active_pattern.data("type") == "color") {
              publisher_message.css(
                "backgroundImage",
                "linear-gradient(45deg, " +
                  active_pattern.data("background-color-1") +
                  ", " +
                  active_pattern.data("background-color-2") +
                  ")"
              );
            } else {
              publisher_message.css(
                ...
                "url(" +
                  uploads_path +
                  "/" +
                  active_pattern.data("background-image") +
                  ")"
              );
            }
  ...
  var typing_timer;
  $("body").on(
    "keyup paste input propertychange",
    ".js_publisher-scraper",
    function () {
      var _this = $(this);
      var publisher = _this.parents(".publisher");
      ...
      if (_this.val()) {
        typing_timer = setTimeout(function () {
          ...
          if (
            publisher.find('.js_publisher-tab.active[data-tab!="location"]')
              .length > 0
          ) {
            return;
          }
            ...
            function (response) {
              ...
              if (response.callback) {
                ...
                if (response.link["source_type"] == "photo") {
                  /* photo */
                  var template = render_template("#scraper-photo", {
                  ...
                  /* media */
                  if (
                    response.link["source_provider"] == "YouTube" ||
                    response.link["source_provider"] == "Facebook" ||
                    response.link["source_provider"] == "Twitch" ||
                    response.link["source_provider"] == "Vimeo"
                  ) {
                    var template = render_template("#scraper-player", {
                      url: response.link["source_url"],
                      title: response.link["source_title"],
                      text: response.link["source_text"],
  ...
  $("body").on(
    "keyup",
    '.publisher-meta[data-meta="album"] input',
    function () {
      if ($(this).val() == "") {
  ...
  $("body").on(
    "keyup",
    '.publisher-meta[data-meta="feelings"] input',
    function () {
      if ($(this).val() == "") {
  ...
  $("body").on("click", "#feelings-menu-toggle", function () {
    ...
    $("#feelings-data input")
      .show()
      .attr("placeholder", $(this).data("init-text"))
      .removeData("action")
      .val("");
  ...
  $("body").on(
    "keyup",
    '.publisher-meta[data-meta="location"] input',
    function () {
      if ($(this).val() == "") {
    ...
    if (_this.hasClass("active")) {
      ...
      if (_this.data("type") == "color") {
        publisher_message.css(
          "backgroundImage",
          "linear-gradient(45deg, " +
            _this.data("background-color-1") +
            ", " +
            _this.data("background-color-2") +
            ")"
        );
      } else {
        publisher_message.css(
          "backgroundImage",
          "url(" + uploads_path + "/" + _this.data("background-image") + ")"
        );
      }
      /* [3] add pattern text-color */
  ...
  $("body").on("keyup", ".js_publisher-gif-search", function () {
    ...
    if (!is_empty(query)) {
      ...
      _this
        .next(".dropdown-menu")
        .show()
        .html('<div class="loader loader_small ptb10"></div>');
      /* get results */
      $.get(
        "https://api.giphy.com/v1/gifs/search?",
        { q: query, api_key: giphy_key, limit: 20 },
        function (response) {
          if (response.meta.status == 200 && response.data.length > 0) {
            _this
              ...
              .show()
              .html(
                "<div class='js_scroller' data-slimScroll-height='180'><div>"
              );
            for (var i = 0; i < response.data.length; i++) {
              _this
                ...
                .append(
                  $(
                    '<div class="item"><img class="js_publisher-gif-add" src="' +
                      response.data[i].images.fixed_height_small.url +
                      '" data-gif="' +
            ...
            _this
              ...
              .show()
              .html(
                '<div class="ptb5 plr10">' + __["No result found"] + "</div>"
              );
          }
        },
        "json"
  ...
  $("body").on("click", ".js_publisher-gif-add", function () {
    ...
    var template = render_template("#pubisher-gif", {
      src: link["source_url"],
    });
    /* show the publisher scraper */
    publisher.find(".publisher-scraper").html(template).fadeIn();
  ...
  $("body").on("keyup", '.publisher-meta[data-meta="poll"] input', function () {
    var $emptyFields = $('.publisher-meta[data-meta="poll"] input').filter(
      function () {
        return $.trim(this.value) === "";
      }
    );
    if (
      $emptyFields.length == $('.publisher-meta[data-meta="poll"] input').length
    ) {
  ...
  $("body").on(
    "focus",
    '.publisher-meta[data-meta="poll"] input:last',
    function () {
  ...
  $("body").on(
    "click",
    ".js_publisher-attachment-image-remover, .js_publisher-mini-attachment-image-remover",
    function () {
      var mini = $(this).hasClass("js_publisher-mini-attachment-image-remover")
        ? true
        : false;
      ...
      var publisher = !mini
        ? $(this).parents(".publisher")
        : $(this).parents(".publisher-mini");
  ...
  $("body").on(
    "click",
    ".js_publisher-mini-attachment-video-remover",
    function () {
      var item = $(this).parents("li.item");
      var src = item.data("src");
      /* remove the attachment from publisher data */
  ...
  $("body").on("click", ".js_publisher-attachment-file-remover", function () {
    ...
    if (type == "video") {
      var attachments_video_thumbnail = publisher.find(
    ...
    publisher
      .find('.js_publisher-tab[data-tab="' + type + '"]')
      .removeClass("activated");
  });
  /* publish new post */
  $("body").on("click", ".js_publisher", function () {
    ...
    /* get colored pattern */
    var colored_pattern_meta = publisher.find(
      '.publisher-meta[data-meta="colored"]'
    );
    /* get voice note */
    var attachments_voice_notes = publisher.find(
      '.publisher-meta[data-meta="voice_notes"]'
    );
    ...
    var poll_options = [];
    publisher
      .find('.publisher-meta[data-meta="poll"] input')
      .each(function (index) {
        if ($(this).val() != "") {
    ...
    /* get video */
    var attachments_video = publisher.find(
      '.publisher-meta[data-meta="video"]'
    );
    var video = publisher.data("video");
    var attachments_video_thumbnail = publisher.find(
      ".publisher-custom-thumbnail"
    );
    var video_thumbnail = attachments_video_thumbnail
      .find("input.js_x-image-input")
      .val();
    /* get audio */
    var attachments_audio = publisher.find(
      '.publisher-meta[data-meta="audio"]'
    );
    ...
    /* get anonymous */
    var is_anonymous = publisher
      .find(".js_publisher-anonymous-toggle")
      .is(":checked");
    /* return if no data to post */
    if (
      is_empty(textarea.val()) &&
      link === undefined &&
      photos === undefined &&
      feeling.val() == "" &&
      location.val() == "" &&
  ...
  $("body").on("click", ".js_voice-start", function () {
    ...
    voice_recording_timer.addEventListener("secondsUpdated", function (e) {
      voice_timer.html(
        voice_recording_timer.getTimeValues().toString(["minutes", "seconds"])
      );
    });
    ...
    navigator.mediaDevices
      ...
      .then(function (stream) {
        ...
        voice_recording_object = new WebAudioRecorder(
          audioContext.createMediaStreamSource(stream),
          {
            workerDir:
              site_path + "/includes/assets/js/plugins/webaudiorecorder/",
            ...
            success: function (response) {
              ...
              if (response.callback) {
                ...
                if (handle == "publisher") {
                  ...
                  publisher
                    .find('.js_publisher-tab[data-tab="' + handle_type + '"]')
                    .addClass("activated");
                  /* enable publisher button */
                  button_status(publisher_button, "reset");
  ...
  async function subscribe(user, mediaType) {
    ...
    live_post_realtime_thread = setInterval(function () {
      ...
      var last_comment_id =
        lightbox.find("ul.js_live-comments .comment:first").data("id") || 0;
      $.post(
        api["live/reaction"],
        {
          do: "stats",
  ...
  function handle_user_unpublished(user) {
    ...
    if (user._video_muted_) {
      $("#js_live-status")
        .html('<i class="fas fa-video-slash mr5"></i>' + __["Video Muted"])
        .show();
      return;
    }
    if (user._audio_muted_) {
      $("#js_live-status")
        .html('<i class="fas fa-microphone-slash mr5"></i>' + __["Audio Muted"])
        .show();
      return;
    }
    $("#js_live-status")
  ...
  $("body").on("click", ".js_lightbox-live", function () {
    ...
    /* load lightbox */
    var lightbox = $(
      render_template("#lightbox-live", { post_id: live_post_id })
    );
  ...
  $("body").on("click", function (e) {
    if (
      $(e.target).hasClass("js_emoji-menu-toggle") ||
      $(e.target).parents(".js_emoji-menu-toggle").length > 0 ||
      $(e.target).hasClass("emoji-menu") ||
      $(e.target).parents(".emoji-menu").length > 0
    ) {
      return;
    }
    $(".emoji-menu").hide();
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_sold-post")
            .addClass("js_unsold-post")
            .find("span")
            .text(__["Mark as Available"]);
        }
      },
      "json"
    ).fail(function () {
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_unsold-post")
            .addClass("js_sold-post")
            .find("span")
            .text(__["Mark as Sold"]);
        }
      },
      "json"
    ).fail(function () {
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_unsold-post")
            .addClass("js_closed-post")
            .find("span")
            .text(__["Mark as Closed"]);
        }
      },
      "json"
    ).fail(function () {
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_save-post")
            .addClass("js_unsave-post")
            .find("span")
            .text(__["Unsave Post"]);
        }
      },
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_unsave-post")
            .addClass("js_save-post")
            .find("span")
            .text(__["Save Post"]);
        }
      },
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_boost-post")
            .addClass("js_unboost-post")
            .find("span")
            .text(__["Unboost Post"]);
        }
      },
      "json"
    ).fail(function () {
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_unboost-post")
            .addClass("js_boost-post")
            .find("span")
            .text(__["Boost Post"]);
        }
      },
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_pin-post")
            .addClass("js_unpin-post")
            .find("span")
            .text(__["Unpin Post"]);
        }
      },
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_unpin-post")
            .addClass("js_pin-post")
            .find("span")
            .text(__["Pin Post"]);
        }
      },
  ...
  $("body").on("click", ".js_disable-post-comments", function () {
    ...
    var id = post.data("id");
    _this
      .removeClass("js_disable-post-comments")
      .addClass("js_enable-post-comments")
      .find("span")
      .text(__["Turn on Commenting"]);
  ...
  $("body").on("click", ".js_enable-post-comments", function () {
    ...
    var id = post.data("id");
    _this
      .removeClass("js_enable-post-comments")
      .addClass("js_disable-post-comments")
      .find("span")
      .text(__["Turn off Commenting"]);
        ...
        $.post(
          ...
          function (response) {
            ...
            if (response.callback) {
              ...
              _this
                .removeClass("js_disallow-post")
                .addClass("js_allow-post")
                .find("span")
                .text(__["Allow on Timeline"]);
            }
          },
          "json"
        ).fail(function () {
    ...
    $.post(
      ...
      function (response) {
        ...
        if (response.callback) {
          ...
          _this
            .removeClass("js_allow-post")
            .addClass("js_disallow-post")
            .find("span")
            .text(__["Hide from Timeline"]);
        }
      },
      "json"
    ).fail(function () {
  ...
  $("body").on("click", ".js_comment", function () {
    var footer = $(this)
      .parents(".post, .lightbox-post, .article")
      .find(".post-footer");
    footer.show();
  ...
  $("body").on("click", ".js_edit-comment", function (e) {
    ...
    comment
      ...
      .hide()
      .after(
        render_template("#edit-comment", {
          text: comment.find(".comment-text-plain:first").text(),
        })
      );
  ...
  $("body").on("click", ".reactions-wrapper", function () {
    if (is_iPad() || $(window).width() < 970) {
      ...
      if (old_reaction) {
        ...
        _parent
          .find(".reaction-btn-name:first")
          .text(__["Like"])
          .removeClass("blue red yellow orange");
        /* change reaction-btn-icon */
        _parent
          .find(".reaction-btn-icon:first")
          .html('<i class="far fa-thumbs-up fa-fw"></i>');
  ...
  $("body").on("click", function (e) {
    if (
      $(e.target).hasClass("reactions-wrapper") ||
      $(e.target).parents(".reactions-wrapper").length > 0
    ) {
      return;
    }
    $(".reactions-container").removeAttr("style").hide();
  ...
  $("body").on(
    "click",
    ".js_react-post, .js_react-photo, .js_react-comment",
    function (e) {
      e.stopPropagation();
      var _this = $(this);
      ...
      if (
        ...
        _parent
          ...
          .text(reaction_title)
          .removeClass("blue red yellow orange")
          .addClass(reaction_color);
        /* change reaction-btn-icon */
        _parent
          .find(".reaction-btn-icon:first")
          .html(
            '<div class="inline-emoji no_animation">' + reaction_html + "</div>"
          );
        /* hide reactions-container */
        _parent.find(".reactions-container:visible").removeAttr("style").hide();
        /* AJAX */
    ...
    $.get(
      ...
      function (response) {
        ...
        $.getJSON(
          ...
          { key: yandex_key, text: text, lang: to_lang },
          function (response) {
            /* check the response */
            _this.removeClass("text-link js_translator").text(__["Translated"]);
            post
              .find(".post-text-translation:first")
              .text(response.text)
              .show()
              .addClass("x-notifier");
            setTimeout(function () {
  ...
  $("body").on("click", ".js_forum-toggle", function () {
    $(this)
      .parents(".forum-category")
      .next(".js_forum-toggle-wrapper")
      .slideToggle();
  });
