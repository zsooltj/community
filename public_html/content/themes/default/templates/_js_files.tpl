...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js" {if !$user->_logged_in}defer{/if}></script>
...
{if $system['auto_play_videos']}
    <script src="{$system['system_url']}/includes/assets/js/plugins/jquery.fracs/jquery.fracs.min.js" {if !$user->_logged_in}defer{/if}></script>
{/if}
...
{if $user->_logged_in}
    ...
    <script src="{$system['system_url']}/includes/assets/js/core/pointsystem.js"></script>
