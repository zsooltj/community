...
/* Smarty version 3.1.40, created on 2022-06-02 07:27:47
  from '/Users/dataexpert/dev/sngine/Script/content/themes/default/templates/_js_templates.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_62986673e7f9d9_72857558',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'de8b48a5048ad0ba3f49103383ce53ae4d0bad68' => 
    array (
      0 => '/Users/dataexpert/dev/sngine/Script/content/themes/default/templates/_js_templates.tpl',
      1 => 1643129368,
      2 => 'file',
    ),
  ),
...
function content_62986673e7f9d9_72857558 (Smarty_Internal_Template $_smarty_tpl) {
...
><!-- Modals --><!-- Theme Switcher --><?php echo '<script'; ?>
 id="theme-switcher" type="text/template"><div class="modal-header"><h6 class="modal-title"><i class="fas fa-paint-roller mr5"></i><?php echo __("Theme Switcher");?>
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body pb0 pt30"><div class="row"><?php
...
><!-- Search --><!-- Lightbox --><?php echo '<script'; ?>
 id="lightbox" type="text/template"><div class="lightbox"><div class="lightbox-container"><div class="lightbox-preview"><div class="lightbox-next js_lightbox-slider"><i class="fa fa-chevron-circle-right fa-3x"></i></div><div class="lightbox-prev js_lightbox-slider"><i class="fa fa-chevron-circle-left fa-3x"></i></div><div class="lightbox-download"><a href="{{image}}" download><?php echo __("Download");?>
</a> - <a target="_blank" href="{{image}}"><?php echo __("View Original");?>
</a></div><img alt="" class="img-fluid" src="{{image}}"></div><div class="lightbox-data"><div class="clearfix"><div class="pt5 pr5 float-right"><button type="button" class="close lightbox-close js_lightbox-close"><span aria-hidden="true">&times;</span></button></div></div><div class="lightbox-post"><div class="js_scroller" data-slimScroll-height="100%"><div class="loader mtb10"></div></div></div></div></div></div><?php echo '</script'; ?>
><?php echo '<script'; ?>
...
" alt=""></div><div class="data-content"><div class="float-right"><i class="fa fa-circle <?php if ($_smarty_tpl->tpl_vars['_user']->value['user_is_online']) {?>online<?php } else { ?>offline<?php }?>"></i></div><div><strong><?php if ($_smarty_tpl->tpl_vars['system']->value['show_usernames_enabled']) {
echo $_smarty_tpl->tpl_vars['_user']->value['user_name'];
} else {
echo $_smarty_tpl->tpl_vars['_user']->value['user_firstname'];?>
 <?php echo $_smarty_tpl->tpl_vars['_user']->value['user_lastname'];
...
<span class="loading-dots"></span></p><div class="twilio-stream-wrapper"><div class="twilio-stream"></div><div class="twilio-stream-local"></div></div><div class="mt30"><button type="button" class="btn btn-light x-hidden js_chat-call-close" data-dismiss="modal"><?php echo __("Close");?>
...
><?php echo '<script'; ?>
 id="gift" type="text/template"><div class="modal-header"><h6 class="modal-title"><i class="fa fa-gift mr5"></i><?php if ($_smarty_tpl->tpl_vars['system']->value['show_usernames_enabled']) {
...
><?php echo '<script'; ?>
 id="scraper-media" type="text/template"><div class="publisher-scraper-remover js_publisher-scraper-remover"><button type="button" class="close"><span>&times;</span></button></div><div>{{{html}}}</div><?php echo '</script'; ?>
><?php echo '<script'; ?>
 id="scraper-player" type="text/template"><div class="publisher-scraper-remover js_publisher-scraper-remover"><button type="button" class="close"><span>&times;</span></button></div><div><div class="embed-responsive embed-responsive-16by9">{{{html}}}</div></div><?php echo '</script'; ?>
><?php echo '<script'; ?>
...
><!-- Comments --><!-- Edit (Posts|Comments) --><?php echo '<script'; ?>
 id="edit-post" type="text/template"><div class="post-edit"><div class="x-form comment-form"><textarea rows="2" class="js_autosize js_mention js_update-post-textarea">{{text}}</textarea><ul class="x-form-tools clearfix"><li class="x-form-tools-emoji js_emoji-menu-toggle"><i class="far fa-smile-wink fa-lg fa-fw"></i></li></ul></div><div class="text-right mt5"><button class="btn btn-sm btn-outline-light plr15 rounded-pill mr5 js_unedit-post"><?php echo __("Cancel");?>
...
><!-- Hidden (Posts|Authors) --><?php }?><!-- Posts [Publisher|Comments] --><!-- Wallet --><?php if ($_smarty_tpl->tpl_vars['page']->value == "wallet") {
echo '<script'; ?>
...
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_transfer"><div class="modal-body"><div class="form-group"><label class="form-control-label"><?php echo __("Amount");?>
...
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_replenish"><div class="modal-body"><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
...
</label><div><span class="badge badge-success text-lg"><?php echo print_money(number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_affiliate_balance'],2));?>
</span></div></div><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
</span><input type="text" class="form-control" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
</button><button type="submit" class="btn btn-primary"><?php echo __("Continue");?>
...
</label><div><span class="badge badge-success text-lg"><?php echo print_money((number_format(((1/$_smarty_tpl->tpl_vars['system']->value['points_per_currency'])*$_smarty_tpl->tpl_vars['user']->value->_data['user_points']),2)));?>
</span></div></div><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
</span><input type="text" class="form-control" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
...
><?php echo '<script'; ?>
 id="wallet-withdraw-funding" type="text/template"><div class="modal-header"><h6 class="modal-title"><i class="fa fa-hand-holding-usd mr5"></i><?php echo __("Withdraw Funding Credit");?>
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_funding"><div class="modal-body"><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Your Funding Credit");?>
</label><div><span class="badge badge-success text-lg"><?php echo print_money(number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_funding_balance'],2));?>
</span></div></div><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
</span><input type="text" class="form-control" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
...
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"><div class="text-center"><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"ready",'class'=>"mb20",'width'=>"100px",'height'=>"100px"), 0, true);
...
echo '<script'; ?>
 id="funding-donate" type="text/template"><div class="modal-header"><h6 class="modal-title"><i class="fas fa-hand-holding-usd mr5"></i><?php echo __("Donate");?>
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><form class="js_ajax-forms" data-url="posts/funding.php?do=donate&post_id={{post_id}}"><div class="modal-body"><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
</span><input type="text" class="form-control" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
</button><button type="submit" class="btn btn-primary"><?php echo __("Continue");?>
...
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body text-center"><div class="row justify-content-center" style="margin-left: -5px; margin-right: -5px;"><?php if ($_smarty_tpl->tpl_vars['system']->value['paypal_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-paypal btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}"{{#id}} data-id="{{id}}" {{/id}}{{#price}} data-price="{{price}}" {{/price}}><i class="fab fa-paypal fa-lg fa-fw mr5" style="color: #00186A;"></i><?php echo __("PayPal");?>
</button></div><?php }
...
if ($_smarty_tpl->tpl_vars['system']->value['paystack_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-paystack btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}"{{#id}} data-id="{{id}}" {{/id}}{{#price}} data-price="{{price}}" {{/price}}><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"paystack",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("Paystack");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['coinpayments_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-coinpayments btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}"{{#id}} data-id="{{id}}" {{/id}}{{#price}} data-price="{{price}}" {{/price}}><i class="fab fa-bitcoin fa-lg fa-fw mr5" style="color: #FFC107;"></i><?php echo __("CoinPayments");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['2checkout_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#twocheckout" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}" }'><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"2co",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("2Checkout");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['bank_transfers_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#bank-transfer" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}" }' data-size="large"><i class="fa fa-university fa-lg fa-fw mr5" style="color: #4CAF50;"></i><?php echo __("Bank Transfer");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['page']->value == "packages" && $_smarty_tpl->tpl_vars['system']->value['packages_wallet_payment_enabled'] && $_smarty_tpl->tpl_vars['system']->value['wallet_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-wallet-package btn btn-block btn-payment plr20" data-id="{{id}}"><i class="fa fa-wallet fa-lg fa-fw mr5" style="color: #007bff;"></i><?php echo __("Wallet Credit");?>
...
</span></div></div><!-- success --><div class="alert alert-success mb0 x-hidden"></div><!-- success --><!-- error --><div class="alert alert-danger mb0 x-hidden"></div><!-- error --></div><div class="modal-footer"><input type="hidden" name="handle" value="{{handle}}"><input type="hidden" name="id" value="{{id}}"><input type="hidden" name="price" value="{{price}}"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
